...
function setup() {
  ...
  bk_song.play ()
  bk_song.setVolume(0.00000000000000000000001);
  ...
  rope1 = new Rope(7,{x:400,y:30});
  rope2 = new Rope(7,{x:400,y:100});
  ...
  blowythingy = createImg ("balloon.png")
  blowythingy.position (10,250)
  blowythingy.mouseClicked (airmovethingy)
  blowythingy.size (150,100)
